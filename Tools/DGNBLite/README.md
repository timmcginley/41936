...
## SOC3.2 – Thermal comfort and indoor air quality (C)              Points total: 125pts
...
## SOC3.3 – Visual comfort (C)            Points total: 85pts
Assessments referred to EN 17037

SOC3.3.1 Daylight availability
...
## SOC3.4 – Acoustic comfort (C)            Points total: 90pts
Assessments referred to EN 17037

SOC3.4.1 Acoustic concept formulated during the planning process
* Consider acoustic comfort in the design               +10pts

SOC3.4.2 Reverberation time (Individual and multi-person offices up to 40m2)
Lv1: 1.0 < T <= 1.5               20pts
Lv2: 0.8 < T < 1.0                30pts
Lv3: T <= 0.8                     40pts

SOC3.4.3 Reverberation time (Multi-person offices larger than 40m2)
Lv1: 0.8 < T < 1.0                30pts
Lv2: T <= 0.8                     40pts
...
# Process
## PRO4.1 - Comprehensive project brief (A)                      Points total: 45pts
PRO4.1.1 Requirements description                    15pts
...
PRO4.1.2 Priorities                                  15pts
* KPIs

PRO4.1.3 Plot and surroundings                       15pts                    
* Access - connection to existing parts / systems of campus.
* Transport
* Parking

## PRO4.2 - Transdisciplinary collaboration and co-design (A-C)              Points total: 120pts
For transdisciplinary collaboration between subjects along the design process.

PRO4.2.1 Early process plan (A)
Specify the purposes and intended outputs for each interaction                                      20pts

PRO4.2.2 Evidence of transdisciplinary design integration (B)
Illustrate in plan and section drawings                                                             50pts

PRO4.2.3 Documentation and description of transdisciplinary workshops between subjects (C)
...
## PRO4.3 Sustainability aspects in tender phase (A-C)                       Points total: 60pts
Address and document your integration of sustainability aspects, at each stage.

PRO4.3.1 Defining sustainability aspects in Week-4 submission (A)                                                           10pts
E.g. Area of opportunities, potential considerations etc.

PRO4.3.2 Inclusion of general sustainability aspects in Week-7 submission (B)                                               20pts
E.g. net-zero strategies, good use of space, inclusion of public green area etc. 

PRO4.3.3 Inclusion of technical sustainability aspects in final client report (C)                                           30pts
E.g. ease of cleaning and maintenance, circular design, optimisation of materials, material recovery etc.

## PRO4.4 – End user considerations during design process (B-C)               Points total: 70pts
...
## PRO4.5– Comprehensive project brief (C)            Points total: 55pts
PRO4.5.1 The building as a whole                                                                       15pts
...
PRO4.5.2 Individual rooms                                                                              15pts
...
PRO4.5.3 Effects on users and on the public                                                            25pts
...
# Technical
## TEC5.1 – Ease of recovery and recycling (D)            Points total: 140pts
TEC5.1.1 Selection of easy-to-recycle construction materials
...
TEC5.1.2 Potential for adaptability and future use                                                                                
1. Develop a conceptual layout of the building for potential future adaptation, from office/public building to living or student accommodation. The concept should be designed from a representative floor of the building and include a highlight of the major changes needed for the adaptations, including Utility, floor plan, heat, and ventilation.                   +35pts

2. Documentation of the potential economic and environmental cost to adapting the building, derived from the conceptual layout. Expressed in dkk/m^2 UA and kgCO2eq/m2 UA. (Only considering new, replaced, or adapted building components, i.e. if the core and outer shell remains unchanged, those should not be considered in the LCA scope)                                 +35pts

## TEC5.2 – Ease of cleaning building components (C)            Points total: 40pts
...
## TEC5.3 – Mobility infrastructure (C)            Points total: 50pts
TEC5.3.1 Bicycle infrastructure
...
TEC5.3.2 User comfort for cycling users                                     20pts
* Available shower facilities
* Available changing rooms
* Available storage facilities

## TEC5.4 – Quality of the building envelope (C)            Points total: 40pts
...
Lv3: Average U-value of exterior wall < -30% of min. Building Regulation requirement            40pts

## TEC5.5 – Fire safety design (C)            Points total: 40pts
TEC5.5.1 Structural fire safety
Parametric structural fire design of individual structural element                              +20pts

TEC5.5.2 
Performance based fire safety design                                                            +20pts

## TEC5.6 – Use and integration of building technology (C)            Points total: 35pts
